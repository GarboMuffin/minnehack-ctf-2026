...
echo
echo "For security reasons, a two-factor authentication code is now required in addition to password"
echo
python3 2fa.py
...
echo "Welcome to the nuclear control panel v2.0" | cowsay -W 80 | lolcat 
